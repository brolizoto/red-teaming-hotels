...
export default function Ansatz() {
  ...
  const seoData = {
    title: "Weitere Einsatzfelder | Red Teaming Switzerland",
    description: "Red Teaming für Brandschutz, Evakuierungen, Krisenmanagement und behördliche Kontrollen.",
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
            ...
            <div className="md:col-span-10">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
                {t('otherFields.whatIsRedTeaming.title')}
              </h2>
              <p className="text-base text-muted-foreground mb-4">
                {t('otherFields.whatIsRedTeaming.description')}
              </p>
              <p className="text-base text-muted-foreground mb-4">
                {t('otherFields.redTeam.description')}
              </p>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
            ...
            <div className="md:col-span-10">
              <div className="accent-line mb-6"></div>
              <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
                {t('otherFields.whatIsNot.title')}
              </h2>
              <p className="text-base text-muted-foreground mb-6">
                {t('otherFields.whatIsNot.item1')}
              </p>
              <div className="bg-card border border-border rounded-lg p-6 mb-6">
                <h3 className="text-lg font-bold text-foreground mb-4">{t('otherFields.whatIsNot.title')}</h3>
                <ul className="space-y-3 text-sm text-muted-foreground">
                  <li className="flex gap-3">
                    <span className="text-primary font-bold">•</span>
                    <span>{t('otherFields.whatIsNot.item1')}</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="text-primary font-bold">•</span>
                    <span>{t('otherFields.whatIsNot.item2')}</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="text-primary font-bold">•</span>
                    <span>{t('otherFields.whatIsNot.item3')}</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="text-primary font-bold">•</span>
                    <span>{t('otherFields.whatIsNot.item1')}</span>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start mb-12">
              ...
              <div className="md:col-span-10">
                <div className="accent-line mb-6"></div>
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
                  {t('otherFields.threeDimensions.title')}
                </h2>
                <p className="text-base text-muted-foreground mb-6">
                  {t('otherFields.threeDimensions.intro')}
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-background border border-border rounded-lg p-6">
                ...
                <h3 className="text-lg font-bold text-foreground mb-3">{t('otherFields.threeDimensions.physical.title')}</h3>
                <p className="text-sm text-muted-foreground mb-4">
                  {t('otherFields.threeDimensions.physical.description')}
                </p>
              ...
              <div className="bg-background border border-border rounded-lg p-6">
                ...
                <h3 className="text-lg font-bold text-foreground mb-3">{t('otherFields.threeDimensions.digital.title')}</h3>
                <p className="text-sm text-muted-foreground mb-4">
                  {t('otherFields.threeDimensions.digital.description')}
                </p>
                <p className="text-xs text-muted-foreground">
                  {t('otherFields.threeDimensions.digital.description')}
                </p>
              ...
              <div className="bg-background border border-border rounded-lg p-6">
                ...
                <h3 className="text-lg font-bold text-foreground mb-3">{t('otherFields.threeDimensions.organizational.title')}</h3>
                <p className="text-sm text-muted-foreground mb-4">
                  {t('otherFields.threeDimensions.organizational.description')}
                </p>
                <p className="text-xs text-muted-foreground">
                  {t('otherFields.threeDimensions.organizational.description')}
                </p>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-card border border-border rounded-lg p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-foreground mb-2">{t('otherFields.process.step1.title')}</h3>
                  <p className="text-sm text-muted-foreground mb-3">
                    {t('otherFields.process.step1.description')}
                  </p>
                  <p className="text-xs text-muted-foreground">
                    {t('otherFields.process.step1.description')}
                  </p>
            ...
            <div className="bg-card border border-border rounded-lg p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-foreground mb-2">{t('otherFields.process.step2.title')}</h3>
                  <p className="text-sm text-muted-foreground mb-3">
                    {t('otherFields.process.step2.description')}
                  </p>
                  <p className="text-xs text-muted-foreground">
                    {t('otherFields.process.step2.description')}
                  </p>
            ...
            <div className="bg-card border border-border rounded-lg p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-foreground mb-2">{t('otherFields.process.step3.title')}</h3>
                  <p className="text-sm text-muted-foreground mb-3">
                    {t('otherFields.process.step3.description')}
                  </p>
                  <p className="text-xs text-muted-foreground">
                    {t('otherFields.process.step3.description')}
                  </p>
            ...
            <div className="bg-card border border-border rounded-lg p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-foreground mb-2">{t('otherFields.process.step4.title')}</h3>
                  <p className="text-sm text-muted-foreground mb-3">
                    {t('otherFields.process.step4.description')}
                  </p>
                  <p className="text-xs text-muted-foreground">
                    {t('otherFields.process.step4.description')}
                  </p>
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-8">
              {t('otherFields.vsOthers.title')}
            </h2>
            <p className="text-base text-muted-foreground mb-8">
              {t('otherFields.vsOthers.intro')}
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-background border border-border rounded-lg p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg font-bold text-foreground">{t('otherFields.vsOthers.redteaming.title')}</h3>
                </div>
                <ul className="space-y-3 text-sm text-muted-foreground">
                  <li className="flex gap-3">
                    <span className="text-primary font-bold">•</span>
                    <span>{t('otherFields.vsOthers.redteaming.description')}</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="text-primary font-bold">•</span>
                    <span>{t('otherFields.vsOthers.redteaming.description')}</span>
              ...
              <div className="bg-background border border-border rounded-lg p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg font-bold text-foreground">{t('otherFields.vsOthers.audit.title')}</h3>
                </div>
                <ul className="space-y-3 text-sm text-muted-foreground">
                  <li className="flex gap-3">
                    <span className="text-muted-foreground font-bold">•</span>
                    <span>{t('otherFields.vsOthers.audit.description')}</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="text-muted-foreground font-bold">•</span>
                    <span>{t('otherFields.vsOthers.audit.description')}</span>
