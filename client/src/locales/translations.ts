...
export const translations = {
  ...
  "approach": {
    ...
    "why": {
      ...
      "gap3": "Dokumentation ist unvollständig, veraltet oder nicht zugänglich",
      "gap4": "Abhängigkeiten zwischen Systemen und Prozessen sind nicht bekannt",
      "gap5": "Entscheidungswege versagen unter Druck",
    ...
    "process": {
      ...
      "phase1": {
        ...
        "desc": "Gemeinsam definieren wir Ziele, Scope und Rahmenbedingungen des Assessments. Welche Szenarien sind relevant? Welche Bereiche sollen geprüft werden? Welche Einschränkungen gibt es?",
        "details": "Ergebnis: Klares Verständnis der Risiken, Ziele und Erwartungen"
      },
      "phase2": {
        "title": "Durchführung",
      ...
      "phase4": {
        ...
        "desc": "Wir liefern einen detaillierten Bericht mit konkreten, umsetzbaren Empfehlungen. Keine theoretischen Konzepte, sondern praktische Massnahmen, die die Handlungsfähigkeit im Ernstfall verbessern.",
        "details": "Ergebnis: Handlungsplan mit priorisierten Massnahmen"
      }
    },
    "comparison": {
  ...
  "otherFields": {
    ...
    "crisis": {
      ...
      "description": "Red Teaming prüft Krisenmanagement-Strukturen unter realistischen Bedingungen. Nicht entlang von Checklisten, sondern entlang von Risiko und Abhängigkeiten.",
      "item1": "Krisenmanagement-Strukturen und Entscheidungswege",
      "item2": "Kommunikation und Eskalationsprozesse",
      "item3": "Verfügbarkeit von Informationen und Systemen",
      "item4": "Zusammenarbeit zwischen Abteilungen und externen Partnern"
    },
    "evacuation": {
      "title": "Evakuierungen",
      "description": "Red Teaming prüft Evakuierungsfähigkeit unter realistischen Bedingungen. Nicht entlang von Checklisten, sondern entlang von Risiko und Abhängigkeiten.",
      "item1": "Evakuierungspläne und Fluchtwege",
      "item2": "Alarmierungssysteme und Kommunikation",
      "item3": "Verfügbarkeit von Evakuationslisten und Informationen",
      "item4": "Zusammenarbeit zwischen Abteilungen und externen Partnern"
    },
    "fire": {
      "title": "Brandschutz",
  ...
  "contact": {
    ...
    "thankYouMessage": "Wir werden Sie in Kürze kontaktieren.",
    "name": "Name",
    "email": "E-Mail",
    "phone": "Telefon",
    "company": "Hotel / Unternehmen",
    "message": "Nachricht",
    "submit": "Gespräch anfragen",
    "required": "* Erforderliche Felder",
    "namePlaceholder": "Ihr Name",
    "emailPlaceholder": "ihre@email.ch",
    "phonePlaceholder": "+41 78 XXX XX XX",
    "companyPlaceholder": "Ihr Hotel",
  ...
  "approach": {
    ...
    "why": {
      ...
      "gap3": "Documentation is incomplete, outdated or inaccessible",
      "gap4": "Dependencies between systems and processes are unknown",
      "gap5": "Decision-making paths fail under pressure",
    ...
    "process": {
      ...
      "phase1": {
        ...
        "desc": "Together we define goals, scope and framework conditions of the assessment. Which scenarios are relevant? Which areas should be tested? What are the constraints?",
        "details": "Result: Clear understanding of risks, goals and expectations"
      },
      "phase2": {
        "title": "Execution",
      ...
      "phase4": {
        ...
        "desc": "We deliver a detailed report with concrete, actionable recommendations. No theoretical concepts, but practical measures that improve capability to act in an emergency.",
        "details": "Result: Action plan with prioritized measures"
      }
    },
    "comparison": {
      "title": "Red Teaming vs. Audits & Penetration Tests",
  ...
  "otherFields": {
    ...
    "companies": {
      "title": "Companies",
      "intro": "Red Teaming for companies tests the resilience of organizations against physical, digital and organizational threats.",
      "description": "We test access control, IT security, crisis management and communication channels under real conditions, not theoretically, but the way an attacker or emergency would.",
      "areasTitle": "Typical test areas:",
      "area1": "Physical security: Access control, perimeter, visitor management",
      "area2": "Digital security: Phishing, social engineering, IT infrastructure",
      "area3": "Organizational resilience: Crisis management, emergency plans, communication",
      "area4": "Process quality: Dependencies, decision-making paths, documentation"
    },
    "locations": {
      "title": "Locations & Facilities",
      "intro": "For companies with multiple locations or critical facilities, we test location-specific security concepts and their implementation.",
      "description": "Particularly relevant for production sites, logistics centers, data centers or locations with special security requirements.",
      "focusTitle": "Focus:",
      "focus1": "Location-specific risks and vulnerabilities",
      "focus2": "Coordination between locations in a crisis",
      "focus3": "Evacuation concepts and emergency plans",
      "focus4": "Local vs. central security responsibility"
    },
    "properties": {
      "title": "Private Properties",
      "intro": "For private properties, residential complexes or real estate with special security requirements, we offer discreet Red Teaming assessments.",
      "description": "We test physical security concepts, access control, surveillance systems and emergency plans under real conditions.",
      "servicesTitle": "Services:",
      "service1": "Discreet testing of physical security measures",
      "service2": "Assessment of access control and perimeter",
      "service3": "Review of surveillance and alarm systems",
      "service4": "Emergency planning and evacuation concepts"
    },
    "fire": {
